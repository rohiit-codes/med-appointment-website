    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row mt-6 gap-5 items-start'>
        <div className='flex flex-col gap-4 text-sm text-gray-600'>
          ...
          <p onClick={()=> speciality === 'Pediatricians' ? navigate('/doctors'): navigate('/doctors/Pediatricians')} className={`gap-3 border border-gray-300 pl-3 pr-16 transition-all cursor-pointer py-2 text-start rounded-md ${speciality === "" ? "bg-indigo-100 text-black":""}`}>Pediatricians</p>
          <p onClick={()=> speciality === 'Neurologist' ? navigate('/doctors'): navigate('/doctors/Neurologist')} className={`gap-3 border border-gray-300 pl-3 pr-16 transition-all cursor-pointer py-2 text-start rounded-md ${speciality === "Pediatricians" ? "bg-indigo-100 text-black":""}`}>Neurologist</p>
